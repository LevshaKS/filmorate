...
public class FilmController {
    ...
    @GetMapping
    public ResponseEntity<Collection<Filme>> filmAll() {
        log.info("вывод списка фильмов");
        return ResponseEntity.ok(films.values());
    }

    @PostMapping
    public ResponseEntity<?> create(@Valid @RequestBody Filme film) {
    ...
    @PutMapping
    public ResponseEntity<?> update(@Valid @RequestBody Filme newFilm) {
        ...
        Filme oldFilm = films.get(newFilm.getId());
